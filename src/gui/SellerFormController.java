...
public class SellerFormController implements Initializable {
	...
	private void notifyDataChangeListeners() {
		...
		// Vai notificar ao observador (a classe SellerListController) que está dentro
		// da lista,
	...
	public void updateFormData() {
		...
		// Seria para mostrar a data no formato local (do formato do computador que está
		// usando)
		// ZoneId.systemDefault(), seria a zona, ou seja, neste caso estamos usando o
		// fuso horário da máquina local do usuário
